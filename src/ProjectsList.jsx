    ...
    },
    {
        ...
        longDesc: (
            <>
                ...
                <p>I was welcomed into the group of <a href="https://github.com/Lublyx" target="_blank">Lucas S.</a>, <a href="https://github.com/aslikerzz" target="_blank">Augustin F.</a>, and <a href="" target="_blank">Issam L.</a> which were working on STORG, a software initially designed to compress and decompress files. The interesting part was that to do so they decided that the compressed file would be an image, and each pixel of that image would have a different hexadecimal color based on the binary data it contains.</p>
                ...
                <p>The main program was written in C#, and the graphic interface uses Avalonia, both run through .NET. The mobile app is desgined with ReactNative and the website with HTML, CSS and JavaScript vanilla. I contributed to making the software cross-platform, especially for OSX, and also heavily contributed to the UI/UX design using figma (cf. the 3rd screenshot). I intend to implement it using Avalonia.</p>
            </>),
        technologies: ["C#", ".NET", "Avalonia", "ReactNative", "Figma", "HTML", "CSS", "JS"],
